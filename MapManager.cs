...
public class MapManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (grid.WorldToCell(worldPoint) != null) //if theres a grid
            {
                //get cell position of grid
                //position = grid.WorldToCell(worldPoint);
            }
        ...
        foreach (Vector3Int pos in groundMap.cellBounds.allPositionsWithin)
            {
                ...
                //Vector3 place = groundMap.WorldToCell(localPlace);
